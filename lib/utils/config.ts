export const config = {
  ...
  poseDetectionService: {
    url: process.env.POSE_DETECTION_SERVICE_URL || process.env.NGROK_POSE_DETECTION_URL || 'http://localhost:5005',
    port: parseInt(process.env.POSE_DETECTION_SERVICE_PORT || '5005', 10),
  },
  drillRecommender: {
